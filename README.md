...
- Система: tmux, btop, bottom, lnav, tldr, procs и Glow для Markdown.
...
На уже настроенной машине достаточно получить новую версию репозитория,
повторно запустить идемпотентный установщик и открыть новый shell:
